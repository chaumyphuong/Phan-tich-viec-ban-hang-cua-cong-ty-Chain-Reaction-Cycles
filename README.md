...
## Quarter dashboard
![Filter by quarter dashboard](./images/quarter_dashboard.png)

This dashboard provides a more detailed view of the business figures of the company's 4 quarters in each year.

### Analysize charts
Next in the dashboard, there are charts showing each index of each quarter that the company is interested in so that it can monitor and analyze business performance, thereby making strategic decisions to improve business performance and maintain sustainable development.
Key Indicators
First in the dashboard we can see the key indicators as follows:
- Pct Standard Cost: 6.45M (estimated cost of producing 1 product)
- Total Pct Cost: 20.88M (total product cost)
- Order Quantity: 25K (number of orders)
- Total Orders: 977K (total orders)
- Sales Amount: 20.68M (revenue)
- Profit: -202.61M (profit)
- Total Customers: 18.49K (total number of customers)
- Profit margin %: -0.98% (profit margin)
- Year: 2019
These indicators help the company quickly grasp the business situation in 2019.
5.4.2. Filter
Based on filter group, channel, category, business type and year, select by North American market, retail channel, bicycle classification and year 2019 to view detailed reports of business figures that the company is interested in for 4 quarters in 2019 because 2019 is always the year with the highest revenue, profit, number of orders and costs because if you view 4 quarters without selecting a filter, you will not know which quarter's report you are viewing.
Chart 1: Sum of Sale Amount and Profit by Quarter (from year drill through)
- Vertical column chart shows total revenue and total profit by 4 quarters in 2019. Evaluate business development by quarter of each year to identify the quarters with the highest revenue and profit, thereby evaluating the effectiveness of implemented business strategies and monitoring revenue and profit growth trends to adjust business plans in a timely manner.
• Q1: 4.4M revenue and 0.1M profit
• Q2: 4.7M revenue and 0.1M profit
• Q3: 5.7M revenue and -0.3M profit
• Q4: 5.8M revenue and -0.1M profit
- Comments:
Revenue:
• Highest revenue: Q4 (5.8M USD)
• Lowest revenue: Q1 (4.4M USD)
Profit:
• Highest profit: Q1, Q2 (0.1M USD)
• Lowest profit: Q3 (-0.3M USD)
- Explanation:
• Q1 and Q2: Revenue increased from 4.4M to 4.7M USD, but profit remained at 0.1M USD. This may be due to well-managed production costs, operating costs, and other costs.
• Q3: Revenue increased compared to Q2 (USD 5.7 million), profit decreased to -USD 0.3 million. This could be due to increased costs, or unexpected expenses.
• Q4: Revenue continued to increase to USD 5.8 million and profit increased to -USD 0.1 million. This could be due to good cost control and increased operating efficiency.
Chart 2: Total sales orders by Quarter (from year drill through)
- The waterfall chart shows the total number of orders by 4 quarters in 2019 to evaluate the level of sales activity. Helps identify the quarters with the highest number of orders, from which you can analyze the causes and optimize your customer outreach strategy. Track changes in the number of orders over the quarters to adjust production forecasts and inventory management.
• Q1: 226 orders
• Q2: 211 orders
• Q3: 259 orders
• Q4: 281 orders
Total: 977 orders
- Comments:
• Highest: Q4 (281 orders)
• Lowest: Q2 (211 orders)
- Explanation:
• Q1: Total orders are 226. This is an average, which may indicate stability in business operations.
• Q2: Total orders dropped to 211. This is the lowest level of the year, which may be due to low seasonality or other market factors.
• Q3: Total orders increased to 259, which indicates a recovery and may be the result of effective business strategies or promotions.
• Q4: Total orders peaked at 281, possibly due to peak shopping season or strong marketing campaigns.
Chart 3: Profit margin by Quarter (from year drill through)
- The horizontal bar chart shows the profit margin by quarter in 2019. From there, the company can evaluate the effectiveness of the implemented business strategies and monitor the profit margin trend to adjust the business plan in time.
• Q1: 2%
• Q2: 2%
• Q3: 6%
• Q4: 1%
...
Lowest: Q4 (1%)
- Explanation:
• Q1 and Q2: Both quarters have a profit margin of 2%, showing stability in business performance. This stability shows that costs are well controlled and the business strategy is working effectively. But the profit margin is low, measures need to be considered to enhance business performance and improve profit margin in the following quarters.
• Q3: Profit margin is the highest at 6%. This shows that business operations in this quarter are effective, possibly due to good cost management and stable revenue.
• Q4: Profit margin drops sharply down 1%. This could be due to increased costs or a sharp decrease in revenue compared to costs.
Chart 4: Sum of Total Product Cost and Sum of Product Standard Cost by Quarter (from year drill through)
- The line chart helps track the fluctuations of total product costs and estimated product manufacturing costs by quarter in 2019 to evaluate the effectiveness of production cost management to help businesses save costs.
• Quarter 1: 4.3M total product cost and 1.4M estimated cost
• Quarter 2: 4.6M total product cost and 1.4M estimated cost
• Quarter 3: 6M total product cost and 1.8M estimated cost
• Quarter 4: 5.9M total product cost and 1.9M estimated cost
- Comments:
Total product cost:
• Highest: Quarter 3 (6M)
• Lowest: Quarter 1 (4.3M)
Estimated cost:
• Highest: Quarter 4 (1.9M)
• Lowest: Quarter 1 and Quarter 2 (1.4M)
- Explanation:
• Quarter 1 and Quarter 2: Total product cost is relatively stable, estimated cost is both at 14M, showing stability in cost management.
• Q3: Total product costs jumped to 6M, possibly due to increased production or other factors. Estimated costs also increased to 1.8M.
• Q4: Total product costs dropped to 5.9M, indicating that cost control efforts were effective. Estimated costs increased to 1.9M.
Chart 5: Sum of Order Quantity by Quarter (from year drill through)
- The pie chart shows the total number of orders by quarter in 2019. From there, it is possible to evaluate the effectiveness of implemented business strategies and identify the quarters with the highest order proportion.
• Q1: 6K orders (21.97%)
• Q2: 6K orders (23.53%)
• Q3: 7K orders (27.66%)
• Q4: 7K orders (26.84%)
- Comments:
• Highest: Q3 (7K orders, 27.66%)
• Lowest: Q1 (6K orders, 21.97%)
- Explanation:
• Q1: The proportion of total orders is 21.97%, showing stability in business activities at the beginning of the year.
• Q2: The proportion of total orders increased to 23.53%, showing stability in business activities.
• Q3: The proportion of total orders continued to increase to 27.66%, possibly due to the shopping season or strong marketing campaigns.
• Quarter 4: The proportion of total order quantity decreased slightly by 26.84%, possibly due to market factors.
Chart 6: Average of Unit Price by Quarter (from year drill through)
- The pie chart shows the average unit price of the product by 4 quarters in 2019 to evaluate the change in selling price. Helps to identify the quarters with the highest and lowest average order price, thereby adjusting the selling price strategy to optimize revenue.
• Quarter 1: 507.31 (27.21%)
• Quarter 2: 457.84 (24.56%)
• Quarter 3: 437.33 (23.46%)
• Quarter 4: 461.78 (24.77%)
- Comments:
• Highest: Quarter 1 (507.31, 27.21%)
• Lowest: Quarter 3 (437.33, 23.46%)
- Explanation:
• Quarter 1: The proportion of average unit price per product is the highest at 27.21%, possibly due to the launch of new products, with higher prices than existing products.
• Quarter 2: The proportion of average unit price per product decreased compared to Quarter 1, accounting for 24.56%, possibly due to summer promotions or price reductions to stimulate consumer demand
• Quarter 3: The proportion of average unit price per product was the lowest at 23.46%, possibly due to the time when consumer demand decreased, and businesses may have to reduce prices to maintain sales
• Quarter 4: The proportion of average unit price per product increased slightly compared to Quarter 3, accounting for 24.77%, possibly due to the time of preparing for the year-end holidays, so customers tend to shop and spend more